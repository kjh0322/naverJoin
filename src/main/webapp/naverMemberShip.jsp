...
<body>
	<header>
		<h1><a href="http://www.naver.com"><img src="img/logo.png" alt="네이버메인 페이지로 이동" class="logo"></a></h1>
	</header>
		...
		<form action="" method="get">
			<ul>
				...
				<li>
					...
					<div class="box">
						<input type="text" id="id" name="userid" maxlength="20" class="inL" required>
						<span class="step_urlinR">@naver.com</span>
					</div>
				...
				<li>
					...
					<div class="box int_pass">
						<input type="password" id="pw1" name="userpw1" maxlength="20" class="inL" required>
				...
				<li>
					...
					<div class="box">
						<input type="password" id="pw2" name="userpw2" maxlength="20" class="inL" required>
				...
				<li>
					...
					<div class="box">	
						<input type="email" id="email" maxlength="50" class="inL" placeholder="선택입력">
					</div>	
				...
				<!-- mobile -->
				<li>
					<h3><label for="mobile">휴대전화</label></h3>
					<div class="box">	
						<input type="tel" id="mobile" maxlength="16" placeholder="전화번호 입력" class="inL">
					</div>	
					<span class="error_next_box"></span>
				</li>
